...
export const Cart = () => {
  ...
  useEffect(()=>{
    alanBtn({
      key: '96803b3ea342319309de915a349acc522e956eca572e1d8b807a3e2338fdd0dc/stage',
      onCommand: (commandData) => {
        if (commandData.command === "getMenu") {
          ...
          setIsModal(commandData.command)
        }
  ...
  return ( 
    <div className="album py-5 pg-light">
      ...
      <div className="fixed-top m-3">
        <button onClick={moduleHandler} type="button" className="btn btn-primary position-relative">
          Card
      ...
      {isModal &&( 
    <div className="modal" tabindex="-1" style={{display: "block", background: "rgba(0, 0, 0, 0.8)"}}>
      <div className="modal-dialog">
        <div className="modal-content">
         <div className="modal-header">
           <h5 className="modal-title">Card</h5>
           <button onClick={moduleHandler} type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
         </div>
         ...
         <div className="modal-footer">
           <button  onClick = {moduleHandler}  type="button" className="btn btn-primary">Close</button>
         </div>
        </div>
      </div>
    </div>
